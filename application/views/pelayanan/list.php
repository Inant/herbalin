            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="" method="get">
                        <div class="row">
                            <div class="col-sm-2 ">
                                <a href="<?= base_url(). 'pelayanan/create' ?>" class="btn btn-success btn-sm"><i class="fa fa-plus-circle"></i> Tambah</a>
                            </div>
                        ...
                        <table class="table table-hover table-striped">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url(). 'pelayanan/edit/'.$key['id_pelayanan'] ?>">
