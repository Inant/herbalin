      ...
      <div class="card">
        <div class="card-body">
            ...
            <?php
              ...
              ?>
            <form action="<?= base_url(). 'pelayanan/create' ?>" enctype="multipart/form-data" method="POST">
              <div class="row">
                ...
                <div class="col-6 mb-3">
                  ...
                  <input type="number" name="harga" id="harga" class="form-control <?= form_error('harga') ? 'is-invalid' : '' ?>" placeholder="Harga" value="<?= set_value('harga') ?>">
                  <div class="invalid-feedback">
                      <?= form_error('harga') ?>
                  </div>
                </div>
