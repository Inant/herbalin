      ...
      <div class="card">
        <div class="card-body">
            ...
            <?php
              ...
              ?>
          <form action="<?= base_url(). 'kategori/edit/'.$kategori[0]['id_kategori'] ?>" enctype="multipart/form-data" method="POST">

              <div class="row">
                <div class="col-6 mb-3">
                  <label for="">Kategori</label>
                  <input type="text" name="kategori" id="kategori" class="form-control <?= form_error('kategori') ? 'is-invalid' : '' ?>" placeholder="Kategori" value="<?= set_value('kategori') ? set_value('kategori') : $kategori[0]['kategori'] ?>">
