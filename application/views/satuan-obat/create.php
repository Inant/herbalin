    ...
    <div class="card">
     <div class="card-body">
      ...
      <?php
        ...
        ?>
      <form action="<?= base_url(). 'satuanobat/create '?>" enctype="multipart/form-data" method="POST">
        <div class="row">
          <div class="col-6 mb-3">
            <label for="">Satuan</label>
            <input type="text" name="satuan" id="satuan" class="form-control <?= form_error('satuan') ? 'is-invalid': ''?>"
            placeholder="Satuan" value="<?= set_value('satuan') ?>">
