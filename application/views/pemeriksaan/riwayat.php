            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-1 ml-auto" style="margin-right:35px;">
                        <button class="btn btn-sm btn-danger" onclick="history.go(-1);"><i class="fa fa-arrow-left"></i> Kembali</button>
                      </div>
                    </div>
                    <br>
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="row">
                                <div class="col-4"><p>Nama &ensp; : <?= $pasien[0]['nama'] ?></p></div>
                                <div class="col-4"><p>Gender &ensp;: <?= $pasien[0]['gender'] ?></p></div>
                                <div class="col-4"><p>Jumlah Kunjungan &ensp; &ensp; : <?= $jml_kunjungan[0]['jml']?></p></div>
                            </div>
                            <div class="row">
                                <div class="col-4"><p>Usia &ensp; &ensp; : <?= $pasien[0]['usia']?></p></div>
                                <div class="col-4"><p>Alamat &ensp;  : <?= $pasien[0]['alamat']?></p></div>
                            </div>
                            <?php        
                                }
                                else{
